...
class InactiveTicketPage extends StatefulWidget {
  const InactiveTicketPage({super.key});

  @override
  State<InactiveTicketPage> createState() => _InactiveTicketPageState();
}

class _InactiveTicketPageState extends State<InactiveTicketPage> {
  ...
  Future<List<dynamic>?>? getdata() async {
    ...
    print(imgurl);
    Uri uri = Uri.parse(UrlResource.INTICKET);
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      // Routes.instance.push(widget:  ViewTicketPage(), context: context);
                    },
                    child: Padding(
